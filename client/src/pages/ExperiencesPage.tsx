...
export default function ExperiencesPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-white px-4 animate-fade-in">
          ...
          {(dateParam || guestsParam) && (
            <div className="mt-8 glass-card rounded-lg px-6 py-4 text-sm flex gap-4">
              {dateParam && (
          ...
          <div className="mt-8 animate-bounce">
            <a href="#experiences-content" className="flex items-center text-white hover:text-accent transition-colors">
      ...
      <div id="experiences-content" className="pt-16 pb-16">
