          ...
          >
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmitAccount)} className="space-y-5">
                {/* Auto-adjusting height container for conversation */}
                <div className="min-h-[350px] relative overflow-y-auto">
                  <div className={`w-full transition-all duration-500 ${accountStep === 'name' ? 'opacity-100 z-10 relative' : 'opacity-0 -z-10 hidden absolute'}`}>
                    {/* Name step */}
                  ...
                  <div className={`w-full transition-all duration-500 ${accountStep === 'email' ? 'opacity-100 z-10 relative' : 'opacity-0 -z-10 hidden absolute'}`}>
                    {/* Email step */}
                    <div className="space-y-5">
                      <div className="p-5 bg-primary/5 backdrop-blur-sm rounded-2xl border border-primary/10 relative">
                        <div className="pl-2">
                  ...
                  <div className={`w-full transition-all duration-500 ${accountStep === 'password' ? 'opacity-100 z-10 relative' : 'opacity-0 -z-10 hidden absolute'}`}>
                    {/* Password step */}
                    <div className="space-y-5">
                      <div className="p-5 bg-primary/5 backdrop-blur-sm rounded-2xl border border-primary/10 relative">
                        <div className="pl-2">
                  ...
                  <div className={`w-full transition-all duration-500 ${accountStep === 'review' ? 'opacity-100 z-10 relative' : 'opacity-0 -z-10 hidden absolute'}`}>
                    {/* Review step */}
                    <div className="space-y-5">
                      <div className="p-5 bg-primary/5 backdrop-blur-sm rounded-2xl border border-primary/10 relative">
                        <div className="pl-2">
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="h-10 w-full bg-gradient-to-r from-primary/20 via-primary/10 to-transparent rounded-full flex items-center">
                <div className="h-10 rounded-full bg-primary/20 flex items-center px-4 text-sm" style={{ width: '66%' }}>
